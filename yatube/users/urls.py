...
urlpatterns = [
    path('signup/', views.SignUp.as_view(extra_context=
                                         {"var": "Зарегистрироваться"}),
         name='signup'),
    ...
    path('login/',
         LoginView.as_view(extra_context=
                           {"var": "Войти", "eto_login": "eto_login"},
                           template_name='users/login.html'),
         name='login'
         ),
    path('password_change/',
         PasswordChangeView.as_view(extra_context=
                                    {"var": "Изменить пароль"},
                                    template_name=
    ...
    path('password_reset/',
         PasswordResetView.as_view(extra_context=
                                   {"var": "Восстановить пароль"},
                                   template_name=
